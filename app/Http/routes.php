...
// Artist
	Route::model('artist', 'ObservantRecords\App\Admin\Models\Artist');
	Route::resource('artist', 'ArtistController');
	Route::get( '/artist/{artist}/delete', array( 'as' => 'artist.delete', 'uses' => 'ArtistController@delete' ) );

// Album
	Route::model('album', 'ObservantRecords\App\Admin\Models\Album');
...
// Release
	Route::model('release', 'ObservantRecords\App\Admin\Models\Release');
...
// Tracks
	Route::model('track', 'ObservantRecords\App\Admin\Models\Track');
...
// Audio
	Route::model('audio', 'ObservantRecords\App\Admin\Models\Audio');
	Route::get( '/audio/{audio}/delete/', array( 'as' => 'audio.delete', 'uses' => 'AudioController@delete' ) );
	Route::resource('audio', 'AudioController');

// Ecommerce
	Route::model('ecommerce', 'ObservantRecords\App\Admin\Models\Ecommerce');
...
// Songs
	Route::model('song', 'ObservantRecords\App\Admin\Models\Song');
...
// Recordings
	Route::model('recording', 'ObservantRecords\App\Admin\Models\Recording');
...
// Profile
	Route::model('user', 'ObservantRecords\App\Admin\Models\User');
